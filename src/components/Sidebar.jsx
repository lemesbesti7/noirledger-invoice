    ...
    <aside className="w-64 h-screen bg-surface border-r border-surface-border flex flex-col shrink-0">
      ...
      <div className="px-6 py-5 border-b border-surface-border">
        <div className="flex items-center gap-3">
          <div className="w-9 h-9 rounded-lg bg-noir-500/20 border border-noir-400/40 flex items-center justify-center">
            <Hexagon className="w-5 h-5 text-noir-400" />
          </div>
          <div>
            <h1 className="text-base font-bold tracking-tight text-white">NoirLedger</h1>
            <p className="text-[11px] text-gray-500 -mt-0.5">Invoice Demo</p>
          </div>
        </div>
      </div>
      ...
      <div className="px-4 py-4 border-t border-surface-border">
        <div className="text-[11px] text-gray-600 space-y-0.5">
          <p className="text-noir-400 font-medium">DEMO ONLY</p>

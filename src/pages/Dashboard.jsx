...
import { FilePlus2, TrendingUp, CheckCircle2, Clock, XCircle, ArrowRight } from 'lucide-react'
    ...
    <div className="space-y-8">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">NoirLedger Invoice — Web3 Demo Overview</p>
        </div>
      ...
      <div className="card">
        ...
        <table className="w-full text-sm">
          ...
          <tbody>
            {recent.map(inv => (
              <tr key={inv.id} className="border-b border-surface-border/50 hover:bg-surface-light/50 transition-colors">

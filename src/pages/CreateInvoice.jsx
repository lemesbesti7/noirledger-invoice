  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-500 mt-1">Generate a new Web3 demo invoice</p>
      </div>
      ...
      <div className="card space-y-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-2">
            <span className="text-xs text-gray-500 mr-2 py-1">Quick add:</span>
            {sampleItems.slice(0, 3).map((s, i) => (
        ...
        {form.items.map((it, idx) => (
          <div key={idx} className="flex gap-3 items-start">
            <div className="flex-1 grid grid-cols-4 gap-3">
              ...
              <input className="input" type="number" min="0" step="0.01" placeholder="Unit Price (USDC)" value={it.unitPrice} onChange={e => itemUpdate(idx, 'unitPrice', Number(e.target.value))} />
            </div>
